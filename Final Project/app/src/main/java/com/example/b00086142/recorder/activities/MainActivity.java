package com.example.b00086142.recorder.activities;
...
import com.example.b00086142.finalproject.databinding.ActivityMainBindingImpl;
import com.example.b00086142.recorder.config.Constants;
import com.example.b00086142.recorder.hardware.BandState;
import com.example.b00086142.recorder.services.CommService;
        ...
        public void handleResponse(Intent response) {
            ...
            switch (response.getAction()) {
                case Constants.Action.BROADCAST_HEART_RATE:
                    ...
                    Toast.makeText(MainActivity.this, "HeartRateTransaction.handleResponse: got heart rate = " + heartRate, Toast.LENGTH_SHORT).show();
