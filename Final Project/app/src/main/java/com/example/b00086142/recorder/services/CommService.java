package com.example.b00086142.recorder.services;
...
import com.example.b00086142.recorder.config.Constants;
import com.example.b00086142.recorder.hardware.BandState;
import com.example.b00086142.recorder.hardware.MiBand2;
import com.example.b00086142.recorder.persistance.DbTool;
import com.example.b00086142.recorder.utils.BytesUtil;
...
public final class CommService extends Service {
    ...
    private DatabaseReference userHeart;
    ...
    public void onCreate() {
        ...
        userHeart = fd.getReference("userHeart/" + FirebaseAuth.getInstance().getUid());
    }
        ...
        mHeartRateWorkThread = new Thread(() -> {
            ...
            if (mBand.getState().isMeasuringHeartRate()) {
                ...
                success = mBand.startMeasureHeartRate(heartRate -> {
                    ...
                    DatabaseReference push = userHeart.push();
                    push.setValue(new HeartRate(System.currentTimeMillis(),heartRate));
